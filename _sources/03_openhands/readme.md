...
Navigate to [openhands.dev](https://www.openhands.dev/), and click on "Try it live". 

Login using your Github account. Select your repository 

![](select_repository.png)

Ask OpenHands to solve you issue:

![](solve_issue1.png)
![](solve_issue2.png)
![](solve_issue3.png)

When OpenHands has finished, create a pull-request with its changes:
